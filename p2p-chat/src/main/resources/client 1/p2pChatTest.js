...
const auth1 = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..mDfj_oHcWB_-IcF8BWvcSiXFpY41ZS05au-UvsGzVvE";
const name = "Kira"
...
function handleAcceptFriendRequest(message) {
    ...
    friendshipClient.send(`/app/friendship/${userId2}`, {}, JSON.stringify({
        ...
        'sender': auth1, // Убедитесь, что переменная auth2 содержит правильные данные пользователя
        'status': 'accepted'
    }));
}
